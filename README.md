...
这是一套面向中文公众号写作者的 Codex skills。它不是一个 Obsidian 插件，也不是一个微信公众号自动发布工具，而是一套可以被 Agent 反复调用的“公众号内容生产方法”。

它解决的问题是：从选题判断、正文写作、标题生成、人工感审校、模板套用、图片处理，到最终复制进公众号后台之前的检查，都有一套固定流程。
...
> Nook Skills 是一套中文公众号写作与发布流程 skills。它不是单纯的 AI 写作提示词，而是把公众号文章生产拆成几个稳定步骤：选题判断、正文写作、标题生成、人工感审校、模板套用、图片图床处理和发布前检查。它适合长期写公众号的人，把每篇文章都放进同一套质量标准和发布流程里。
...
9. 这套 skills 的核心不是“帮你偷懒”，而是让每次写作都有稳定流程。
